...
class HangoutsDialog extends Component {
    static propTypes = {
    ...
    validate() {
        ...
        if (this.state.id === undefined) {
            this.props.addService('hangouts', this.state.title.trim());
        } else {
...
export default connect(mapStateToProps, mapDispatchToProps)(HangoutsDialog);
